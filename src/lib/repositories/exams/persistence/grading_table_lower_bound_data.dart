...
class GradingTableLowerBoundData {
  ...
  const GradingTableLowerBoundData(
      {required this.points, required this.grade, required this.examId});
  ...
  static GradingTableLowerBoundData fromModel(
          GradingTableLowerBound model, Exam exam) =>
      GradingTableLowerBoundData(
          grade: model.grade, points: model.points, examId: exam.id);
